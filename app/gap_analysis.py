...
SYSTEM_PROMPT = (
    ...
    "description that the resume does not demonstrate. Both matched_skills and "
    "missing_skills must be short skill or technology names only (e.g. 'Kubernetes'), "
    "never full sentences or phrases like 'Experience with Kubernetes'. "
    "Ground everything in the resume and job description text — never invent skills "
    "or requirements not present in either. This analysis is advisory only, not a "
    "pass/fail judgment of the candidate."
)
